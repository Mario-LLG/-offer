...
我所做的工作就是重新编辑，可能对于完善makefile文档作用不大，但是我觉得是一次自己对这一知识点的重新梳理，在陈浩版makefile +祝冬华整理的基础上，用markdown编辑器重新编辑了一遍，主要目的是加深自己学习印象，并且书写一个更加漂亮的排版格式，这篇文章我会上传到CSDN，并且会附上github源文件链接，如果需要，可自行下载修正。
